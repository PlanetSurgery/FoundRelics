...
def Handle_Data(main_window, data):
    try:
        if data:
            ...
            main_window.dev_panel.Set_Name(f"{player_name} || Echelon {echelon}")
            ...
            main_window.dev_panel.Set_Level(final_string)
            ...
            if main_window.last_progress is None:
                ...
                if adventure_name:
                    ...
                    main_window.dev_panel.Set_Map(favorite_map)
                ...
                main_window.dev_panel.Set_GMarket("{:,}".format(main_window.market_gold))
                main_window.dev_panel.Set_EMarket("{:,}".format(main_window.market_enj))
            ...
            main_window.dev_panel.Set_Count(main_window.run_count)
            main_window.dev_panel.Set_Time(main_window.run_time_total)
            json_text = json.dumps(data, indent=2)
            main_window.json_panel.Set_JSON(json_text)
