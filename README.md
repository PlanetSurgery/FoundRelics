...
1. **Install Python:**  
   Ensure you have Python v3.10 installed on your machine. If not, download it [here](https://www.python.org/downloads/). If you are using a different version, you will need to edit the Setup & Run script.
