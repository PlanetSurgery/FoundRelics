...
class DonatePanel(QFrame):
    def __init__(self, parent=None):
        ...
        instruction = QLabel("Please scan the QR code with your ENJ wallet to donate any amount you want. I greatly appreciate any support at all, even if just vocal!")
